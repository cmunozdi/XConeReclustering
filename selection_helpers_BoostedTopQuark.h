...
inline void initializeCorrectionSet(bool isMC = true, const std::string &jec_override = "") {
    ...
    if (!jec_override.empty()) {
        ...
        g_jec_tag = g_isMC ? "Summer22_22Sep2023_V3_MC" : "Summer22_22Sep2023_RunCD_V3_DATA"; //"Summer23BPixPrompt23_V3_MC" : "Summer23BPixPrompt23_V3_DATA"; //"Summer22EE_22Sep2023_V3_MC" : "Summer22EE_22Sep2023_RunE_V3_DATA"; //"Summer23Prompt23_V2_MC" : "Summer23Prompt23_V2_DATA";
    }
